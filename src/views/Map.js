...
const MapWrapper = () => {
    ...
    return (
        <div>
            ...
            <div id="chart-container" style={{ display: 'flex', alignItems: 'flex-start', flexDirection: windowWidth < 768 ? 'column' : 'row' }}>
                <div id="map" style={{ height: '600px', width: windowWidth < 768 ? '100%' : '600px', marginRight: '20px' }}></div>
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', width: windowWidth < 768 ? '100%' : 'auto' }}>
                    <svg id="barChart" width={windowWidth < 768 ? '100%' : '600'} height="400"></svg>
...
const InfoCard = () => {
    ...
    return (
        <Card className="map-card">
            <Helmet>
                <title>Most Significant Attacks</title>
            </Helmet>
            <CardBody>
